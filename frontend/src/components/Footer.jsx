        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              >
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zM16.747 20.69h2.042L7.747 3.308H5.58l11.167 17.382z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/books" className="text-white/80 hover:text-white">Browse Books</Link></li>
              <li><Link to="/sell" className="text-white/80 hover:text-white">Sell Books</Link></li>
              <li><Link to="/login" className="text-white/80 hover:text-white">Sign In</Link></li>
              <li><Link to="/register" className="text-white/80 hover:text-white">Register</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/shipping" className="text-white/80 hover:text-white">Shipping Policy</Link></li>
              <li><Link to="/returns" className="text-white/80 hover:text-white">Returns & Exchanges</Link></li>
