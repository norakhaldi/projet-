...
function Categories() {
  const categories = [
    ...
    { name: 'medical', icon: <MagnifyingGlassIcon className="h-6 w-6 text-maroon group-hover:hidden" />, iconHover: <MagnifyingGlassIconSolid className="h-6 w-6 text-maroon hidden group-hover:block" />, link: '/books?category=medical' },
